	...
	return UIComponent.extend("com.9b.PlantoLog.Component", {
		...
		_getDialog: function () {
			if (!this.dialog) {
				...
				this.dialog = sap.ui.xmlfragment("sessionDialog", "com.9b.PlantoLog.view.fragments.SessionTimeoutDialog", this);
			}
			return this.dialog;
		},
